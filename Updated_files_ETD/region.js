...
d3.csv("https://dataproducts.fia.org/Region_dashboard1.csv", function(error, spendData) {
...
.legend(dc.legend().x(600).y(0).itemHeight(15).gap(5).horizontal(1).legendWidth(600).itemWidth(120))
...
d3.csv("https://dataproducts.fia.org/region3.csv", function(error, spendData) {
var ndx = crossfilter(spendData);
allDim = ndx.dimension(function(d) {return d.Volume;});
                ...
                columnDefs: [
                    {
                        "orderable": true,
                        targets: 0,
                        data: function (d) { return d.FIA_Region; }
                    },
                    {
                        "orderable": true,
                        targets: 1,
