...
d3.csv("https://rawgit.com/ovik-chakraborty/Tutorial/master/Group_dashboard.csv", function(error, spendData) {
...
.legend(dc.legend().x(530).y(0).itemHeight(15).gap(5).horizontal(1).legendWidth(900).itemWidth(100))
...
d3.csv("https://rawgit.com/ovik-chakraborty/Tutorial/master/group1.csv", function(error, spendData) {
var ndx = crossfilter(spendData);
allDim = ndx.dimension(function(d) {return d.Volume;});
                ...
                columnDefs: [
                    {
                        "orderable": true,
                        targets: 0,
                        data: function (d) { return d.Instrument_Group_Name; }
                    },
                    {
                        "orderable": true,
                        targets: 1,
